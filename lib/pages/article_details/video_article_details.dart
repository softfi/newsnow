                          ...
                          children: [
                            Row(
                              children: <Widget>[
                                Container(
                                    ...
                                    decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(5), color: Theme.of(context).colorScheme.onBackground),
                            ...
                            Text(
                              ...
                              style: Theme.of(context)
                                  .textTheme
                                  .titleLarge
                                  ?.copyWith(fontWeight: FontWeight.bold, wordSpacing: 1.8, letterSpacing: -0.5),
                            ),
                            Divider(
                                  ...
                                  child: Row(
                                    children: [
                                      ClipOval(
                                        child: SizedBox(
                                          height: 40,
                                          child: CachedNetworkImage(imageUrl: article.avatar.toString()),
                                        ),
                                      ),
                                      const SizedBox(
                                        width: 10,
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      TextButton.icon(
                                        ...
                                        onPressed: () => nextScreenPopupiOS(context, CommentsPage(article: article)),
                                      )
                                    ],
                                  ),
                                ),
